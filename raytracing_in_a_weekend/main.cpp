...
int main()
{
    ...
    list[2] = new sphere(vec3(1.0f, 0.0f, -1.0f), 0.5f, new metal<datatype>(vec3(0.8f, 0.6f, 0.2f), 1.0f));
    list[3] = new sphere(vec3(-1.0f, 0.0, -1.0f), 0.5f, new metal<datatype>(vec3(0.8f, 0.8f, 0.8f), 0.1f));
